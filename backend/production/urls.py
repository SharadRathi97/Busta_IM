...
urlpatterns = [
    ...
    path("products/markers/<int:marker_id>/delete/", views.delete_marker, name="delete_marker"),
    ...
    path("orders/<int:order_id>/complete-marker/", views.complete_marker_production_order_action, name="complete_marker_order"),
